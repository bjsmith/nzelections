...
#View(party_votes_2020)

maori_general_totals<- (
  party_votes_2020 %>% filter(Electorate %in% c("General Electorate Totals","Māori Electorate Totals"))
)



#determine parties who will be included in the count (5% or won an electorate)
all_total<-party_votes_2020[nrow(party_votes_2020),]
...
parties_in_parliament <-calculate_parties_in_parliament(all_total_numeric_cols,electorate_votes_winners_2020)
